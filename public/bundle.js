...
var App = function (_React$Component) {
  ...
  function App() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = App.__proto__ || Object.getPrototypeOf(App)).call.apply(_ref, [this].concat(args))), _this), _this.state = {}, _this.buzzerClick = function () {
      _config.io.sendPush('hello');
  ...
  _createClass(App, [{
    ...
    value: function componentDidMount() {
      _config.io.updateButton(function () {
...
var io = {
  ...
  updateButton: function updateButton(cb) {
    console.log('working');
